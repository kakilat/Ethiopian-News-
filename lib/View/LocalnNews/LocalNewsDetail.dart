...
class LodalNewsDetail extends StatefulWidget {
  DocumentSnapshot snapshot;
  LodalNewsDetail(this.snapshot);
  @override
  _LodalNewsDetailState createState() => _LodalNewsDetailState();
}

class _LodalNewsDetailState extends State<LodalNewsDetail> {
