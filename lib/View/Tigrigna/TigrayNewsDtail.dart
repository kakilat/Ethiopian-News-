...
class TigrignaDtail extends StatefulWidget {
  DocumentSnapshot snapshot;

  TigrignaDtail(this.snapshot);
  @override
  _TigrignaDtailState createState() => _TigrignaDtailState();
}

class _TigrignaDtailState extends State<TigrignaDtail> {
