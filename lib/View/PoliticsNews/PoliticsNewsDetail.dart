...
class PoliticalNewsDetail extends StatefulWidget {
  DocumentSnapshot snapshot;
  PoliticalNewsDetail(this.snapshot);
  @override
  _PoliticalNewsDetailState createState() => _PoliticalNewsDetailState();
}

class _PoliticalNewsDetailState extends State<PoliticalNewsDetail> {
